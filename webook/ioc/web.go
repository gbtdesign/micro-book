...
import (
	...
	"golang/webook/internal/web/middleware"

	"golang/webook/pkg/ginx"
	"golang/webook/pkg/ginx/middlewares/metric"
...
func corsHdl() gin.HandlerFunc {
	return cors.New(cors.Config{
		...
		AllowOriginFunc: func(origin string) bool {
			...
			return strings.Contains(origin, "http://69.165.72.174:3001")
		},
		MaxAge: 12 * time.Hour,
	})
}
